...
from parameterized import parameterized  # pylint: disable=E0401
from utils import access_nested_map, get_json, memoize
from client import GithubOrgClient  # pylint: disable=W0611
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self):
        ...
        with patch.object(TestClass, 'a_method') as mock:
            test = TestClass()
            test.a_property  # pylint: disable=W0104
            test.a_property  # pylint: disable=W0104
